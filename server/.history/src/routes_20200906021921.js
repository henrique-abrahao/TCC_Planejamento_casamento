...
routes.post("/login", async (req, res) => {
  ...
  let user = await knex('cliente').column('nome_noiva',{by: 'name'}, 'email_noiva', 'data_casamento').select().where('email_noiva', req.body.email).andWhere('password', req.body.pass);
