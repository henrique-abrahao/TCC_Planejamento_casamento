  ...
  render() {
    return (
      <Nav defaultActiveKey="/home" as="ul">
        <Nav.Item as="li">
          <Nav.Link href={this.props.list ? "/listplace" : "/createplace"} disabled={this.props.id === 1}>Salão</Nav.Link>
        </Nav.Item>
        <Nav.Item as="li" >
          <Nav.Link href="link-1" disabled={this.props.id === 2}>Buffet</Nav.Link>
        </Nav.Item>
        <Nav.Item as="li" >
          <Nav.Link href={this.props.list ? "/listphoto" :"/createphoto"} disabled={this.props.id === 3}>fotógrafo</Nav.Link>
        </Nav.Item>
        <Nav.Item as="li" >
