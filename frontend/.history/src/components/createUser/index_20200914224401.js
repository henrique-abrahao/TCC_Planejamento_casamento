...
import { validaCpf } from '../../validators/validators'
...
class CreateUsers extends React.Component {
  ...
  CreateUsers = async () => {
    ...
    const validator = validaCpf(this.state.cpf_noiva) && validaCpf(this.state.cpf_noivo);

    if (validator) return console.log('cpf valido');
    return console.log('cpf invalidos');
