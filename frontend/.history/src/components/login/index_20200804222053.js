        ...
        <Card style={{ width: '500px', alignSelf: 'center' }}>
          ...
          <Form style={{ margin: '0px 30px 20px 30px'}}>
            <Form.Group controlId="formBasicEmail">
              ...
              <Form.Control type="email"  value={this.state.email} placeholder="Digite seu e-mail" />
            </Form.Group>

            <Form.Group controlId="formBasicPassword">
              <Form.Label>Senha</Form.Label>
              <Form.Control type="password"  value={this.state.pass}  placeholder="Digite sua senha" />
            </Form.Group>
